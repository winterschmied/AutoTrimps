...
**EASY INSTALL click here: https://genbtc.github.io/AutoTrimps-stableraw/.user.js** (the Monkeys will detect this and prompt you to install it)

Overly detailed Chrome/TamperMonkey Instructions:
- Open the TamperMonkey dashboard and go to utilities – in the URL box paste https://genbtc.github.io/AutoTrimps-stableraw/.user.js and click IMPORT
...
- Visit this URL, and Agree to install the userscript:  https://genbtc.github.io/AutoTrimps-stableraw/.user.js
